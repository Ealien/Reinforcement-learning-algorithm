...
class DoubleDQN:
    def __init__(self,
        ...
        # consist of [evaluate_net, target_net]
        self._build_net()
    ...
    #     # --------------- build evaluate_net ---------------
    #     with tf.variable_scope('eval_net'):
    #         # input is current state, number of neurons is 20, activate function is relu()
    #         e1 = tf.layers.dense(self.s, 20, activation=tf.nn.relu,
    #                              kernel_initializer=w_initializer,
    #                              bias_initializer=b_initializer,
    #                              name='e1')
    #         # output is value of n_actions in current state
    ...
    #     # --------------- build target_net ---------------
    #     with tf.variable_scope('target_net'):
    #         t1 = tf.layers.dense(self.s_, 20, activation=tf.nn.relu,
    #                              kernel_initializer=w_initializer,
    #                              bias_initializer=b_initializer,
    #                              name='t1')
    #         self.q_next = tf.layers.dense(t1, self.n_actions,
    #                                       kernel_initializer=w_initializer,
    #                                       bias_initializer=b_initializer,
    #                                       name='t2')
    #
    ...
    def learn(self):
        # check to replace target_net parameters
        if self.learn_step_counter % self.replace_target_iter == 0:
            self.sess.run(self.target_replace_op)
            print('\ntarget_parameters_replaced\n')

        # sample batch memory for all memory
